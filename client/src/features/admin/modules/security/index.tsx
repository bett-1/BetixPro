...
export default function SecurityWizard() {
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-4 sm:space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <AdminSectionHeader
          ...
          {!isEnabled ? (
            <AdminCard className="p-0 h-full border-admin-border/50 bg-[#0b1426]/40 shadow-2xl backdrop-blur-xl rounded-3xl overflow-hidden">
              <div className="flex flex-col h-full">
                <div className="px-4 py-3 sm:px-6 sm:py-5 bg-gradient-to-br from-white/[0.03] to-transparent">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                    <div className="flex items-center gap-4">
                      <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-xl sm:rounded-2xl bg-admin-accent/10 text-admin-accent border border-admin-accent/20 shadow-[0_0_20px_rgba(245,197,24,0.1)]">
                    ...
                    <div className="flex items-center gap-3 bg-black/20 px-3 py-1.5 sm:px-4 sm:py-2 rounded-xl sm:rounded-2xl border border-white/5">
                      <span className="text-[9px] sm:text-[10px] font-bold text-admin-text-muted uppercase tracking-widest mr-1 sm:mr-2">Step {setupStep} of 2</span>
                    ...
                    <div className="animate-in fade-in slide-in-from-right-4 duration-500">
                      ...
                      <div className="grid gap-4 sm:grid-cols-2">
                        <button
                          ...
                          className="group relative flex flex-col items-start p-4 sm:p-6 rounded-2xl border border-white/5 bg-[#0d2137]/40 hover:bg-[#1a3a6b]/30 hover:border-[#f5c518]/30 transition-all duration-500 text-left shadow-lg overflow-hidden"
                        >
                  ...
                  {setupStep === 2 && (
                    <div className="flex flex-col items-center justify-center py-6 animate-in fade-in slide-in-from-right-4 duration-700">
                      <div className="relative mb-8">
                        ...
                        <div className="relative h-16 w-16 sm:h-20 sm:w-20 flex items-center justify-center rounded-xl sm:rounded-2xl bg-[#f5c518]/10 text-[#f5c518] border border-[#f5c518]/20 shadow-[inset_0_0_20px_rgba(245,197,24,0.1)]">
                          <QrCode size={28} className="sm:size-9" />
                        </div>
                      </div>
                      ...
                      <div className="mt-10 flex gap-3">
                        <Button
                          ...
                          onClick={() => setSetupStep(1)}
                           className="h-10 sm:h-12 px-4 sm:px-8 rounded-xl border-white/10 hover:bg-white/5 active:scale-95 transition-all text-xs"
                        >
                        ...
                        <Button
                          ...
                          disabled={startSetup.isPending}
                           className="h-10 sm:h-12 px-6 sm:px-10 rounded-xl bg-[#f5c518] text-[#0d2137] font-bold shadow-xl shadow-[#f5c518]/20 hover:bg-[#e6b800] active:scale-95 transition-all text-xs uppercase tracking-wider"
                        >
            ...
            <AdminCard className="flex h-full flex-col items-center justify-center border-emerald-500/10 bg-[#0b1426]/40 p-6 sm:p-12 text-center shadow-2xl rounded-3xl overflow-hidden relative group">
              ...
              <div className="relative mb-8">
                ...
                <div className="relative flex h-16 w-16 sm:h-24 sm:w-24 items-center justify-center rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 shadow-[inset_0_0_30px_rgba(16,185,129,0.1)]">
                  <CheckCircle2 size={32} className="sm:size-12 animate-in zoom-in-50 duration-700" />
                </div>
              </div>
      ...
      <Dialog open={isQrModalOpen} onOpenChange={setIsQrModalOpen}>
        <AdminDialogContent className="max-w-[95vw] sm:max-w-2xl p-0 overflow-hidden border-white/5">
           <DialogHeader className="p-5 pb-0 sm:p-8 sm:pb-0">
           ...
           <div className="p-5 sm:p-8">
             <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
                   ...
                   <div className="relative flex shrink-0 items-center justify-center rounded-2xl border-2 border-admin-accent/20 bg-white p-4 shadow-2xl">
                     {qrCodeDataUrl ? (
                       <img
                         ...
                         className="h-40 w-40 sm:h-48 sm:w-48 transition-transform duration-500 group-hover:scale-105"
                       />
                     ) : (
               ...
               <div className="flex flex-col space-y-6">
                 <div className="rounded-2xl border border-white/5 bg-black/30 p-5 sm:p-6 backdrop-blur-sm">
                   ...
                   <div className="relative">
                     <input
                       ...
                       placeholder="000000"
                       className="h-14 sm:h-16 w-full rounded-xl border border-white/10 bg-black/40 px-4 text-center text-2xl sm:text-3xl font-mono font-bold tracking-[0.2em] text-admin-accent outline-none focus:border-admin-accent/40 focus:ring-4 focus:ring-admin-accent/5 transition-all placeholder:opacity-20"
                     />
                   </div>
                 ...
                 <Button
                   ...
                   className="h-12 sm:h-14 w-full rounded-xl bg-admin-accent text-admin-bg font-bold shadow-xl shadow-admin-accent/20 hover:bg-admin-accent-strong active:scale-95 transition-all uppercase tracking-[0.2em] text-xs"
                 >
                   {enable2FA.isPending ? (
