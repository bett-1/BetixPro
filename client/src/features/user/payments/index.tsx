  ...
  return (
    <ProtectedRoute>
      <section className="animate-lift-in grid gap-5 xl:grid-cols-[250px_1fr]">
        <aside className="h-fit rounded-3xl border border-admin-border bg-admin-card/95 p-4 xl:sticky xl:top-24">
          <div className="mb-3 rounded-2xl border border-admin-border bg-admin-surface p-3">
        ...
        <div className="rounded-3xl border border-admin-border bg-admin-surface/95 p-4 sm:p-6">
          <Outlet />
        </div>
      </section>
    </ProtectedRoute>
