    ...
    <div className="flex h-full min-h-0 flex-col overflow-hidden rounded-2xl border border-[#2a3f55] bg-[#0d1820] text-white shadow-2xl">
      ...
      <div className="flex shrink-0 items-center justify-between border-b border-[#2a3f55] bg-[#111f2f] px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <span className="flex h-5 items-center justify-center rounded-full bg-[#f5a623]/20 px-2 text-[10px] font-bold text-[#f5a623] sm:text-[11px]">
            {selections.length}
          </span>
        </div>
        {onClose && (
      ...
      <div className="shrink-0 space-y-3 border-t border-[#2a3f55] bg-[#0d1820] p-3">
          ...
          <div className="grid grid-cols-4 gap-1.5">
            {[100, 500, 1000, 5000].map((amount) => (
              <button
                ...
                className="flex h-8 items-center justify-center rounded border border-[#2a3f55] bg-[#1a2940] text-[10px] font-medium text-[#8fa3b1] transition hover:border-[#f5a623] hover:bg-[#20324c] hover:text-white sm:text-[11px]"
              >
                +{amount}
              </button>
            ))}
        ...
        <div className="rounded-lg border border-[#1d4c2d] bg-[#10261a] p-2.5">
          <div className="mb-2 flex items-end justify-between">
            <div>
              <p className="text-[10px] text-[#8fa3b1] sm:text-[11px]">
                Potential Win
              </p>
              <p className="text-xs font-bold text-[#00c853] sm:text-sm">
                {formatCurrency(potentialPayout)}
              </p>
            </div>
            <div className="text-right">
              <p className="text-[9px] text-[#8fa3b1] sm:text-[10px]">
          ...
          <div className="grid grid-cols-3 gap-2 border-t border-[#1d4c2d]/50 pt-2 text-[10px] sm:text-[11px]">
            <div>
...
export default function BetSlip(props: UseBetSlipReturn) {
  ...
  return (
    <>
      ...
      <div
        className="fixed right-0 z-[900] hidden h-[calc(100vh-var(--navbar-height))] w-[320px] overflow-y-auto border-l border-white/10 bg-[#0b1625]/35 p-3 shadow-[-4px_0_15px_rgba(0,0,0,0.3)] md:flex md:flex-col"
